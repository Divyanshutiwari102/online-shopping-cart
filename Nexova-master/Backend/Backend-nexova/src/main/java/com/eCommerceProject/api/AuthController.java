...
public class AuthController {
    ...
    public AuthController(AuthenticationManager authenticationManager, JwtTokenProvider jwtTokenProvider,
                          UserService userService, PasswordEncoder passwordEncoder, SendEmailService sendEmailService) {
    ...
    public String login(@RequestBody UserLoginRequest loginRequest) {
        ...
        String loginBody = "Login detected on your Nexova account at: " + new Date()
                + "\nIf this wasn't you, please change your password immediately.";
        sendEmailService.sendEmails(user.getEMail(), loginBody, ECommerceMessage.LOGIN_TOPIC);
    ...
    public ResponseEntity<String> register(@RequestBody UserCreateRequest user) throws AddressException {
        ...
        sendEmailService.sendEmails(user.getEMail(),
                ECommerceMessage.REGISTER_BODY,
                ECommerceMessage.REGISTER_TOPIC + ECommerceMessage.REGISTER_TOPIC_EMOJI);
        return new ResponseEntity<>(ECommerceMessage.USER_CREATED, HttpStatus.CREATED);
    }

    @DeleteMapping("/deleteByUser")
    public ResponseEntity<?> deleteByUser(@RequestBody UserDeleteRequest req) {
        userService.authDeleteByUser(req);
        sendEmailService.sendEmails(req.getEMail(),
                ECommerceMessage.AUTH_DELETE_BODY,
                ECommerceMessage.AUTH_DELETE_TOPIC + ECommerceMessage.AUTH_DELETE_TOPIC_EMOJI);
